...
const progressBar = new ProgressBar(':letters letters, :pages pages, :podcasts podcasts, :details details, :memory MB used, :rate per sec', {total: Number.MAX_SAFE_INTEGER})
